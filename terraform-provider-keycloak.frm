...
action:
  ...
  command:
    ...
    - |
      ...
      git clone --single-branch --branch release-v0.1-rc1 https://github.com/tazjin/terraform-provider-keycloak /go/src/github.com/tazjin/terraform-provider-keycloak
